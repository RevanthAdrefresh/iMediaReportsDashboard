...
//   useEffect(() => {
//     const saved = localStorage.getItem("uploadedSheets");
...
//       localStorage.setItem("uploadedSheets", JSON.stringify(parsedSheets)); // ✅ Save to localStorage
//     };
...
//   // ✅ Reset function
//   const handleReset = () => {
//     localStorage.removeItem("uploadedSheets");
//     setSheets([]);
//   };
